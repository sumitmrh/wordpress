...
/**
 * Class Webenvo_Customizer_Repeater.
 */
class Webenvo_Customizer_Repeater extends WP_Customize_Control {
	...
	/**
	 * Webenvo_Customizer_Repeater constructor.
	 *
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$this->add_field_label = esc_html__( 'Add new field', 'webenvo' );
		if ( ! empty( $args['add_field_label'] ) ) {
			$this->add_field_label = $args['add_field_label'];
		}

		$this->boxtitle = esc_html__( 'Customizer Repeater', 'webenvo' );
		if ( ! empty( $args['item_name'] ) ) {
			$this->boxtitle = $args['item_name'];
		} elseif ( ! empty( $this->label ) ) {
			$this->boxtitle = $this->label;
		}
		$this->boxdesc = esc_html__( '', 'webenvo' );
		...
		if ( file_exists( get_template_directory() . '/webenvo-native-customizer-control/customizer-repeater/inc/icons.php' ) ) {
			$this->customizer_icon_container = '/webenvo-native-customizer-control/customizer-repeater/inc/icons';
		}
	...
	public function enqueue() {
		wp_enqueue_style( 'font-awesome', get_template_directory_uri() . '/webenvo-native-customizer-control/customizer-repeater/fontawesome/css/fontawesome.min.css', array(), CUSTOMIZER_REPEATER_VERSION );
		wp_enqueue_style( 'font-awesome-brands', get_template_directory_uri() . '/webenvo-native-customizer-control/customizer-repeater/fontawesome/css/brands.css', array(), CUSTOMIZER_REPEATER_VERSION );
		wp_enqueue_style( 'font-awesome-solids', get_template_directory_uri() . '/webenvo-native-customizer-control/customizer-repeater/fontawesome/css/solid.css', array(), CUSTOMIZER_REPEATER_VERSION );
		wp_enqueue_style( 'font-awesome-v5', get_template_directory_uri() . '/webenvo-native-customizer-control/customizer-repeater/fontawesome/css/v5-font-face.css', array(), CUSTOMIZER_REPEATER_VERSION );
		wp_enqueue_style( 'font-awesome-v4', get_template_directory_uri() . '/webenvo-native-customizer-control/customizer-repeater/fontawesome/css/v4-font-face.css', array(), CUSTOMIZER_REPEATER_VERSION );

		wp_enqueue_style( 'customizer-repeater-admin-stylesheet', get_template_directory_uri() . '/webenvo-native-customizer-control/customizer-repeater/css/admin-style.css', array(), CUSTOMIZER_REPEATER_VERSION );

		wp_enqueue_style( 'wp-color-picker' );

		wp_enqueue_script( 'customizer-repeater-script', get_template_directory_uri() . '/webenvo-native-customizer-control/customizer-repeater/js/customizer_repeater.js', array( 'jquery', 'jquery-ui-draggable', 'wp-color-picker' ), CUSTOMIZER_REPEATER_VERSION, true );

		wp_enqueue_script( 'customizer-repeater-fontawesome-iconpicker', get_template_directory_uri() . '/webenvo-native-customizer-control/customizer-repeater/js/fontawesome-iconpicker.min.js', array( 'jquery' ), CUSTOMIZER_REPEATER_VERSION, true );

		wp_enqueue_style( 'customizer-repeater-fontawesome-iconpicker-script', get_template_directory_uri() . '/webenvo-native-customizer-control/customizer-repeater/css/fontawesome-iconpicker.min.css', array(), CUSTOMIZER_REPEATER_VERSION );
	}
				...
				<div class="customizer-repeater-general-control-repeater-container customizer-repeater-draggable">
					...
					<div class="customizer-repeater-box-content-hidden">
						...
						if ( $this->customizer_repeater_color_control == true ) {
							$this->input_control(
								array(
									'label'             => apply_filters( 'repeater_input_labels_filter', esc_html__( 'Color', 'webenvo' ), $this->id, 'customizer_repeater_color_control' ),
						...
						if ( $this->customizer_repeater_color2_control == true ) {
							$this->input_control(
								array(
									'label'             => apply_filters( 'repeater_input_labels_filter', esc_html__( 'Color', 'webenvo' ), $this->id, 'customizer_repeater_color2_control' ),
						...
						if ( $this->customizer_repeater_title_control == true ) {
							$this->input_control(
								array(
									'label' => apply_filters( 'repeater_input_labels_filter', esc_html__( 'Title', 'webenvo' ), $this->id, 'customizer_repeater_title_control' ),
						...
						if ( $this->customizer_repeater_subtitle_control == true ) {
							$this->input_control(
								array(
									'label' => apply_filters( 'repeater_input_labels_filter', esc_html__( 'Subtitle', 'webenvo' ), $this->id, 'customizer_repeater_subtitle_control' ),
						...
						if ( $this->customizer_repeater_text_control == true ) {
							$this->input_control(
								array(
									'label' => apply_filters( 'repeater_input_labels_filter', esc_html__( 'Text', 'webenvo' ), $this->id, 'customizer_repeater_text_control' ),
						...
						if ( $this->customizer_repeater_btntitle_control == true ) {
							$this->input_control(
								array(
									'label' => apply_filters( 'repeater_input_labels_filter', esc_html__( 'Button Text', 'webenvo' ), $this->id, 'customizer_repeater_btntitle_control' ),
						...
						if ( $this->customizer_repeater_link_control ) {
							$this->input_control(
								array(
									'label'             => apply_filters( 'repeater_input_labels_filter', esc_html__( 'Link', 'webenvo' ), $this->id, 'customizer_repeater_link_control' ),
						...
						if ( $this->customizer_repeater_text2_control == true ) {
							$this->input_control(
								array(
									'label' => apply_filters( 'repeater_input_labels_filter', esc_html__( 'Text', 'webenvo' ), $this->id, 'customizer_repeater_text2_control' ),
						...
						if ( $this->customizer_repeater_link2_control ) {
							$this->input_control(
								array(
									'label'             => apply_filters( 'repeater_input_labels_filter', esc_html__( 'Link', 'webenvo' ), $this->id, 'customizer_repeater_link2_control' ),
						...
						if ( $this->customizer_repeater_shortcode_control == true ) {
							$this->input_control(
								array(
									'label' => apply_filters( 'repeater_input_labels_filter', esc_html__( 'Shortcode', 'webenvo' ), $this->id, 'customizer_repeater_shortcode_control' ),
						...
						?>
						>
							<?php esc_html_e( 'Delete field', 'webenvo' ); ?>
						</button>
...
>
			<span class="customize-control-title">
				<?php esc_html_e( 'Icon', 'webenvo' ); ?>
			</span>
			<span class="description customize-control-description">
				<?php
				echo sprintf(
					/* translators: %1$s is Fontawesome link */
					esc_html__( 'Note: Some icons may not be displayed here. You can see the full list of icons at %1$s.', 'webenvo' ),
					sprintf( '<a href="http://fontawesome.io/icons/" rel="nofollow">%s</a>', esc_html__( 'http://fontawesome.io/icons/', 'webenvo' ) )
				);
				?>
			</span>
...
>
			<span class="customize-control-title">
				<?php esc_html_e( 'Image', 'webenvo' ); ?>
			</span>
			<input type="text" class="widefat custom-media-url" value="<?php echo esc_attr( $value ); ?>">
			<input type="button" class="button button-secondary customizer-repeater-custom-media-button" value="<?php esc_attr_e( 'Upload Image', 'webenvo' ); ?>" />
		</div>
		<?php
	}
	...
	private function icon_type_choice( $value = 'customizer_repeater_icon' ) {
		?>
		<span class="customize-control-title">
			<?php esc_html_e( 'Image type', 'webenvo' ); ?>
		</span>
		<select class="customizer-repeater-image-choice">
			<option value="customizer_repeater_icon" <?php selected( $value, 'customizer_repeater_icon' ); ?>><?php esc_html_e( 'Icon', 'webenvo' ); ?></option>
			<option value="customizer_repeater_image" <?php selected( $value, 'customizer_repeater_image' ); ?>><?php esc_html_e( 'Image', 'webenvo' ); ?></option>
			<option value="customizer_repeater_none" <?php selected( $value, 'customizer_repeater_none' ); ?>><?php esc_html_e( 'None', 'webenvo' ); ?></option>
		</select>
		<?php
	}
	...
	private function repeater_control( $value = '' ) {
		...
		$show_del        = 0;
		?>
		<span class="customize-control-title"><?php esc_html_e( 'Social icons', 'webenvo' ); ?></span>
		<?php
		...
		if ( ( count( $social_repeater ) == 1 && '' === $social_repeater[0] ) || empty( $social_repeater ) ) {
			...
			<div class="customizer-repeater-social-repeater">
				<div class="customizer-repeater-social-repeater-container">
					...
					<?php get_template_part( $this->customizer_icon_container ); ?>
					<input type="text" class="customizer-repeater-social-repeater-link" placeholder="<?php esc_attr_e( 'Link', 'webenvo' ); ?>">
					<input type="hidden" class="customizer-repeater-social-repeater-id" value="">
					<button class="social-repeater-remove-social-item" style="display:none">
						<?php esc_html_e( 'Remove Icon', 'webenvo' ); ?>
					</button>
				</div>
				<input type="hidden" id="social-repeater-socials-repeater-colector" class="social-repeater-socials-repeater-colector" value=""/>
			</div>
			<button class="social-repeater-add-social-item button-secondary"><?php esc_html_e( 'Add Icon', 'webenvo' ); ?></button>
			<?php
		} else {
			?>
			<div class="customizer-repeater-social-repeater">
				...
				foreach ( $social_repeater as $social_icon ) {
					...
					<div class="customizer-repeater-social-repeater-container">
						...
						<?php get_template_part( $this->customizer_icon_container ); ?>
						<input type="text" class="customizer-repeater-social-repeater-link" placeholder="<?php esc_attr_e( 'Link', 'webenvo' ); ?>" value="<?php if ( ! empty( $social_icon['link'] ) ) { echo esc_url( $social_icon['link'] ); } ?>">
						...
						"><?php esc_html_e( 'Remove Icon', 'webenvo' ); ?></button>
					</div>
					<?php
				}
				?>
