...
define( 'WEBENVO_MULTISELECT_VERSION', '1.0.0' );
 ...
 * @access public
 */
class Webenvo_Customizer_Select_Multiple extends WP_Customize_Control {
	/**
	...
	public function enqueue() {
		wp_enqueue_script( 'customizer-select-multiple', get_template_directory_uri() . '/customizer-select-multiple/js/script-customizer-select-multiple.js', array( 'jquery', 'customize-base' ), WEBENVO_MULTISELECT_VERSION, true );
