...
define( 'WEBENVO_ALPHA_VERSION', '1.0.0' );

/**
 * Class Hestia_Customize_Alpha_Color_Control
 */
class Webenvo_Customizer_Alpha_Color_Control extends WP_Customize_Control {
	/**
	...
	public function enqueue() {
		wp_enqueue_script(
			...
			get_template_directory_uri() . '/webenvo-native-customizer-control/customizer-alpha-color-picker/js/alpha-color-picker.js',
			array( 'jquery', 'wp-color-picker' ),
			WEBENVO_ALPHA_VERSION,
			true
		);
		wp_enqueue_style(
			'customizer-alpha-color-picker',
			get_template_directory_uri() . '/webenvo-native-customizer-control/customizer-alpha-color-picker/css/alpha-color-picker.css',
