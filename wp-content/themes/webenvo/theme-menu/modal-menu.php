		...
		<div class="menu-wrapper section-inner">
			...
			<div class="menu-top">
				...
				if ( has_nav_menu( 'expanded' ) ) {
					...
					<nav class="expanded-menu<?php echo esc_attr( $expanded_nav_classes ); ?>" aria-label="<?php echo esc_attr_x( 'Expanded', 'menu', 'webenvo' ); ?>" role="navigation">
				...
				if ( 'expanded' !== $mobile_menu_location ) {
					...
					<nav class="mobile-menu" aria-label="<?php echo esc_attr_x( 'Mobile', 'menu', 'webenvo' ); ?>" role="navigation">
			...
			<div class="menu-bottom">
				...
				<?php if ( has_nav_menu( 'social' ) ) { ?>
					...
					<nav aria-label="<?php esc_attr_e( 'Expanded Social links', 'webenvo' ); ?>" role="navigation">
