...
if ( class_exists( 'WP_Customize_Control' ) ) {
	 ...
	 */
	 class Skyrocket_Image_Checkbox_Custom_Control extends Skyrocket_Custom_Control {
		...
		public function enqueue() {
			wp_enqueue_style( 'skyrocket-custom-controls-css', $this->get_skyrocket_resource_url() . '/webenvo-customizer-custom-control/css/customizer.css', array(), '1.0', 'all' );
		}
		/**
	...
	class Skyrocket_Single_Accordion_Custom_Control extends Skyrocket_Custom_Control {
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'skyrocket-custom-controls-js', $this->get_skyrocket_resource_url() . '/webenvo-customizer-custom-control/js/customizer.js', array( 'jquery' ), '1.0', true );
			wp_enqueue_style( 'skyrocket-custom-controls-css', $this->get_skyrocket_resource_url() . '/webenvo-customizer-custom-control/css/customizer.css', array(), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
	...
	class Skyrocket_Slider_Custom_Control extends Skyrocket_Custom_Control {
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'skyrocket-custom-controls-js', $this->get_skyrocket_resource_url() . '/webenvo-customizer-custom-control/js/customizer.js', array( 'jquery', 'jquery-ui-core' ), '1.0', true );
			wp_enqueue_style( 'skyrocket-custom-controls-css', $this->get_skyrocket_resource_url() . '/webenvo-customizer-custom-control/css/customizer.css', array(), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
	...
	class Skyrocket_Dropdown_Select2_Custom_Control extends Skyrocket_Custom_Control {
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'skyrocket-select2-js', $this->get_skyrocket_resource_url() . '/webenvo-customizer-custom-control/js/select2.full.min.js', array( 'jquery' ), '4.0.13', true );
			wp_enqueue_script( 'skyrocket-custom-controls-js', $this->get_skyrocket_resource_url() . '/webenvo-customizer-custom-control/js/customizer.js', array( 'skyrocket-select2-js' ), '1.0', true );
			wp_enqueue_style( 'skyrocket-custom-controls-css', $this->get_skyrocket_resource_url() . '/webenvo-customizer-custom-control/css/customizer.css', array(), '1.1', 'all' );
			wp_enqueue_style( 'skyrocket-select2-css', $this->get_skyrocket_resource_url() . '/webenvo-customizer-custom-control/css/select2.min.css', array(), '4.0.13', 'all' );
		}
		/**
		 * Render the control in the customizer
		 */
		...
		public function render_content() {
			...
			if( !empty($this->fontList) ) {
				...
				<div class="google_fonts_select_control">
					...
					<div class="customize-control-description"><?php esc_html_e( 'Select weight & style for regular text', 'webenvo' ) ?></div>
					...
					<div class="customize-control-description"><?php esc_html_e( 'Select weight for', 'webenvo' ) ?> <italic><?php esc_html_e( 'italic text', 'webenvo' ) ?></italic></div>
					<div class="weight-style">
					...
					<div class="customize-control-description"><?php esc_html_e( 'Select weight for', 'webenvo' ) ?> <strong><?php esc_html_e( 'bold text', 'webenvo' ) ?></strong></div>
					<div class="weight-style">
	...
	class Skyrocket_Customize_Alpha_Color_Control extends Skyrocket_Custom_Control {
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'skyrocket-custom-controls-js', $this->get_skyrocket_resource_url() . '/webenvo-customizer-custom-control/js/customizer.js', array( 'jquery', 'wp-color-picker' ), '1.0', true );
			wp_enqueue_style( 'skyrocket-custom-controls-css', $this->get_skyrocket_resource_url() . '/webenvo-customizer-custom-control/css/customizer.css', array( 'wp-color-picker' ), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
		 */
	...
	class Skyrocket_Alpha_Color_Control extends Skyrocket_Custom_Control {
		...
		public function enqueue() {
			wp_enqueue_style( 'skyrocket-custom-controls-css', $this->get_skyrocket_resource_url() . '/webenvo-customizer-custom-control/css/customizer.css', array(), '1.0', 'all' );
			wp_enqueue_script( 'wp-color-picker-alpha', $this->get_skyrocket_resource_url() . '/webenvo-customizer-custom-control/js/wp-color-picker-alpha-min.js', array( 'wp-color-picker' ), '1.0', true );
	...
	class Skyrocket_Pill_Checkbox_Custom_Control extends Skyrocket_Custom_Control {
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'skyrocket-custom-controls-js', $this->get_skyrocket_resource_url() . '/webenvo-customizer-custom-control/js/customizer.js', array( 'jquery', 'jquery-ui-core' ), '1.1', true );
			wp_enqueue_style( 'skyrocket-custom-controls-css', $this->get_skyrocket_resource_url() . '/webenvo-customizer-custom-control/css/customizer.css', array(), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
