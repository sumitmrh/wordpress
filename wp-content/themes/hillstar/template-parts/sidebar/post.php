...
?>
<div disabled-ui="true" data-colibri-id="28-s1" class="style-158 style-local-28-s1 position-relative">
    ...
    <div class="h-section-grid-container h-section-boxed-container">
      <div data-colibri-id="28-s3" class="h-row-container gutters-row-lg-0 gutters-row-md-0 gutters-row-2 gutters-row-v-lg-0 gutters-row-v-md-0 gutters-row-v-2 style-164 style-local-28-s3 position-relative">
        <div class="h-row justify-content-lg-center justify-content-md-center justify-content-center align-items-lg-stretch align-items-md-stretch align-items-stretch gutters-col-lg-0 gutters-col-md-0 gutters-col-2 gutters-col-v-lg-0 gutters-col-v-md-0 gutters-col-v-2">
          <div class="h-column h-column-container d-flex h-col-lg h-col-md h-col-auto style-165-outer style-local-28-s4-outer">
            <div data-colibri-id="28-s4" class="d-flex h-flex-basis h-column__inner h-px-lg-0 h-px-md-0 h-px-0 v-inner-lg-0 v-inner-md-0 v-inner-0 style-165 style-local-28-s4 position-relative">
              <div class="w-100 h-y-container h-column__content h-column__v-align flex-basis-100 align-self-lg-start align-self-md-start align-self-start">
                <div data-colibri-component="widget-area" data-colibri-id="28-s5" id="widget-area" class="h-widget-area style-334 style-local-28-s5 position-relative h-element">
                  <div class="widget-shortcode h-global-transition-all">
                    <?php hillstar_widget_area(array (
                      'id' => 'sidebar-1',
                    )); ?>
                  </div>
                </div>
